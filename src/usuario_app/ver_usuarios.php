...
$query = "SELECT usuario_username, usuario_nombre, usuario_direccion, usuario_email, usuario_telefono, usuario_fecha_nacimiento, usuario_fecha_creacion, usuario_fecha_edicion
FROM usuario u;";
...
echo "
 <div class='container-fluid container-view'>
        ...
        <div class='row'>
            ...
            <div class='col col-12 col-barra-busqueda'>
                <form method='GET'>
                    <div class='input-group '>
                        ...
                        <a href='/bebidas/src/usuario_app/registrar_usuario.php' class='btn mr-auto my-auto btn-agregar-registro ' title='Agregar registro de usuario' >
            ...
            <div class='col-12 mt-4 col-table  mx-auto'>
