...
<head>
    ...
    <title>Registrar Prooveedor</title>
...
<body class="body-form">
    <div class="row align-items-center row-form">
        <div class="col-8 mx-auto">
           <form action="" method="POST" class="form-crud">
                ...
                <div class="row">
                    <div class="col-12">
                        <legend class="text-center" >Registrar Proveedor</legend>
                    </div>
                    <div class="col-12 text-center">
                        <div class="form-group">
                            <strong>Proveedor:</strong> <br> <input type="text" name="proveedor_nombre" id="id_proveedor_nombre" required> 
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <strong>Email:</strong> <br> <input type="email" name="email" id="id_email" 
    ...
    <?php 
        ...
        $proveedor = $_REQUEST["proveedor_nombre"];       
        $telefono = $_REQUEST["telefono"];
        $direccion = $_REQUEST["direccion"];
        $email = $_REQUEST["email"];

        $proveedor = clean_string($proveedor);
        $direccion = clean_string($direccion);
        $telefono = clean_string($telefono);
        $email = clean_string($email);

        $query = 'INSERT INTO proveedor(proveedor_nombre, proveedor_telefono, proveedor_direccion, proveedor_email) 
                    VALUES (" '. $proveedor .' ","'. $telefono .'","'. $direccion .'","'. $email .'")';

        if ($mysqli->query($query)) {
            header('Location: http://localhost/bebidas/src/proveedor_app/ver_proveedores.php');
            echo "Ammmmmm";
        }else {
            echo "<strong>Error:</strong> <i>" . $mysqli->error . "</i>";
        } 
